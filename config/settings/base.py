...
DATAFORSEO_USERNAME = env("DATAFORSEO_USERNAME", default=None)
DATAFORSEO_PASSWORD = env("DATAFORSEO_PASSWORD", default=None)
DATAFORSEO_ENABLED_MODULES = env(
    "DATAFORSEO_ENABLED_MODULES",
    default="SERP,KEYWORDS_DATA,BACKLINKS,ONPAGE,DATAFORSEO_LABS",
)
DATAFORSEO_MAX_TOOL_CALLS = env.int("DATAFORSEO_MAX_TOOL_CALLS", default=3)
